...
import com.tyuan.model.base.pojo.SysSourceExample.Criteria;
import com.tyuan.model.base.pojo.SysSourceExample.Criterion;
...
public class SysSourceSqlProvider {
    ...
    public String insertSelective(SysSource record) {
        ...
        if (record.getIsLeaf() != null) {
            VALUES("is_leaf", "#{isLeaf,jdbcType=BIT}");
        }

        if (record.getIsShow() != null) {
            VALUES("is_show", "#{isShow,jdbcType=BIT}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getIsLeaf() != null) {
            SET("is_leaf = #{record.isLeaf,jdbcType=BIT}");
        }

        if (record.getIsShow() != null) {
            SET("is_show = #{record.isShow,jdbcType=BIT}");
        }
     ...
     * @mbggenerated
     */
    protected void applyWhere(SysSourceExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
