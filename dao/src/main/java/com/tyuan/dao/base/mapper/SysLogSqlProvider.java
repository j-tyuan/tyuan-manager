...
import com.tyuan.model.base.pojo.SysLogExample.Criteria;
import com.tyuan.model.base.pojo.SysLogExample.Criterion;
...
public class SysLogSqlProvider {
    ...
    public String insertSelective(SysLogWithBLOBs record) {
        ...
        if (record.getRequestId() != null) {
            VALUES("request_id", "#{requestId,jdbcType=VARCHAR}");
        }
