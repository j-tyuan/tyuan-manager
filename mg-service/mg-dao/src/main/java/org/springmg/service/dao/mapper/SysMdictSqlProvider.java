...
import org.springmg.service.model.pojo.SysMdict;
import org.springmg.service.model.pojo.SysMdictExample.Criteria;
import org.springmg.service.model.pojo.SysMdictExample.Criterion;
import org.springmg.service.model.pojo.SysMdictExample;
...
public class SysMdictSqlProvider {
    ...
    public String countByExample(SysMdictExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("sys_mdict");
     ...
     * @mbg.generated
     */
    protected void applyWhere(SQL sql, SysMdictExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
