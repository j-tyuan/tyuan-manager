...
import org.tyuan.service.dao.mapper.customize.manage.CSysSourceMapper;
...
public class SysSourceServiceImpl implements SysSourceService {
    ...
    public void add(SysSource sysSource) throws ServiceException {
        ...
        sysSource.setId(UUID.randomUUID().toString());
    ...
    @Override
    public SysSource getById(String id) {
    ...
    @Override
    public List<SysSource> getByParentId(String parentId) {
