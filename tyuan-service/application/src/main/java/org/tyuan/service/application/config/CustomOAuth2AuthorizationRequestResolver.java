...
import org.tyuan.common.http.MiscUtils;
import org.tyuan.service.application.service.security.auth.oauth2.TbOAuth2ParameterNames;
import org.tyuan.service.application.service.security.model.token.OAuth2AppTokenFactory;
...
@Service("oAuth2AuthorizationRequestResolver")
@Slf4j
