...
import org.tyuan.service.system.model.pojo.SysUserAvatarExample.Criteria;
import org.tyuan.service.system.model.pojo.SysUserAvatarExample.Criterion;
...
public class SysUserAvatarSqlProvider {
     ...
     * @mbg.generated
     */
    public String countByExample(SysUserAvatarExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("sys_user_avatar");
     ...
     * @mbg.generated
     */
    public String deleteByExample(SysUserAvatarExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("sys_user_avatar");
        applyWhere(sql, example, false);
        return sql.toString();
    }
     ...
     * @mbg.generated
     */
    public String selectByExampleWithBLOBs(SysUserAvatarExample example) {
        SQL sql = new SQL();
     ...
     * @mbg.generated
     */
    public String selectByExample(SysUserAvatarExample example) {
        SQL sql = new SQL();
        if (example != null && example.isDistinct()) {
            sql.SELECT_DISTINCT("id");
        } else {
     ...
     * @mbg.generated
     */
    protected void applyWhere(SQL sql, SysUserAvatarExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
