...
public class LogAspect {
    ...
    public void saveSysLog(JoinPoint joinPoint) {
        ...
        context.setLogConsumer(logObj -> {
            SysLogWithBLOBs logWithBLOBs = (SysLogWithBLOBs) logObj;
            CompletableFuture.runAsync(() -> {
                try {
                    ...
                    sysLog.setDuration(logWithBLOBs.getDuration());
                    sysLog.setException(logWithBLOBs.getException());
    ...
    public void handleThrowing(JoinPoint joinPoint, Exception e) {
        ...
        context.getLogConsumer().accept(withBLOBs);
    }
