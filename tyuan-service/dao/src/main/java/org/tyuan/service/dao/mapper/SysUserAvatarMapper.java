...
public interface SysUserAvatarMapper {
     ...
     */
    @Insert({
        "insert into sys_user_avatar (id, create_time, ",
        "update_time, user_avatar)",
        "values (#{id,jdbcType=VARCHAR}, #{createTime,jdbcType=TIMESTAMP}, ",
        "#{updateTime,jdbcType=TIMESTAMP}, #{userAvatar,jdbcType=LONGVARCHAR})"
    })
    ...
    SysUserAvatar selectByPrimaryKey(String id);
