...
public interface SysUserCredentialsMapper {
     ...
     */
    @Insert({
        "insert into sys_user_credentials (id, create_time, ",
        "update_time, user_id, ",
        "activate_token, enabled, ",
        ...
        "#{activateToken,jdbcType=VARCHAR}, #{enabled,jdbcType=BIT}, ",
        "#{password,jdbcType=VARCHAR}, #{resetToken,jdbcType=VARCHAR})"
    })
    ...
    SysUserCredentials selectByPrimaryKey(String id);
