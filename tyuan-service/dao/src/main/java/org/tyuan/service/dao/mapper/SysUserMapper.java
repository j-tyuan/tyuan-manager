...
public interface SysUserMapper {
    ...
    @Insert({
        ...
        "#{userPhone,jdbcType=VARCHAR}, #{instId,jdbcType=BIGINT}, ",
        "#{instName,jdbcType=VARCHAR}, #{mobile,jdbcType=VARCHAR}, ",
        ...
        "#{userNo,jdbcType=VARCHAR}, #{avatarId,jdbcType=BIGINT})"
    })
    ...
    @Select({
        "select",
        "id, create_time, update_time, user_account, user_pwd, user_name, user_email, ",
        "user_phone, inst_id, inst_name, mobile, user_type, login_ip, login_date, login_flag, ",
        "create_by, update_by, remarks, del_flag, disabled, user_no, avatar_id",
        "from sys_user",
        "where id = #{id,jdbcType=BIGINT}"
    })
    @Results({
