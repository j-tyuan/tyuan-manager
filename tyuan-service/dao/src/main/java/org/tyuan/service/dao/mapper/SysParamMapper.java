...
public interface SysParamMapper {
     ...
     */
    @Insert({
        "insert into sys_param (id, create_time, ",
        "update_time, param_name, ",
        "param_key, is_sys, create_by, ",
        "update_by, remarks, ",
        "param_val)",
        "values (#{id,jdbcType=VARCHAR}, #{createTime,jdbcType=TIMESTAMP}, ",
        "#{updateTime,jdbcType=TIMESTAMP}, #{paramName,jdbcType=VARCHAR}, ",
        "#{paramKey,jdbcType=VARCHAR}, #{isSys,jdbcType=BIT}, #{createBy,jdbcType=VARCHAR}, ",
        "#{updateBy,jdbcType=VARCHAR}, #{remarks,jdbcType=VARCHAR}, ",
        "#{paramVal,jdbcType=LONGVARCHAR})"
    })
