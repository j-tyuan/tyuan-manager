...
public interface OrganizationInstitutionMapper {
     ...
     */
    @Insert({
        "insert into organization_institution (id, create_time, ",
        "update_time, parent_id, ",
        "inst_code, inst_name, ",
        "inst_type, owner_user_id, ",
        "inst_sort, inst_status, ",
        "remarks)",
        "values (#{id,jdbcType=VARCHAR}, #{createTime,jdbcType=TIMESTAMP}, ",
        "#{updateTime,jdbcType=TIMESTAMP}, #{parentId,jdbcType=VARCHAR}, ",
        "#{instCode,jdbcType=VARCHAR}, #{instName,jdbcType=VARCHAR}, ",
        "#{instType,jdbcType=INTEGER}, #{ownerUserId,jdbcType=VARCHAR}, ",
        "#{instSort,jdbcType=INTEGER}, #{instStatus,jdbcType=INTEGER}, ",
    ...
    @Results({
        ...
        @Result(column="owner_user_id", property="ownerUserId", jdbcType=JdbcType.VARCHAR),
    ...
    OrganizationInstitution selectByPrimaryKey(String id);
